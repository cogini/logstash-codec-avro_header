...
# }
#
class LogStash::Codecs::LogstashCodecAvroHeader < LogStash::Codecs::Base

  # The codec name
  config_name "logstash-codec-avro_header"
...
end # class LogStash::Codecs::LogstashCodecAvroHeader
